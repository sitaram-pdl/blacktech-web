...
import { TermsCondition } from "~sections/utility";
...
export default function SignIn() {
  ...
  const login = () => {
    ...
    axios
      .post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/employee/login?version=1.0`,
        {
          email: state.email,
      ...
      .catch((error) => {
        ...
        setErrormsg1("Password didnot match");
  ...
  const TermsCondition1 = (res) => {
    if (res.data.user.isNewUser) return setShow(true);
    res.data.workPlaces.length > 1 ? router.push("/innerpage/welcome") : null;
    res.data.workPlaces.length === 0 ? router.push("innerpage/sign-inn") : null;
    res.data.workPlaces.length === 1
      ? (window.location = "https://dunga.restrox.co/")
      : null;
  };

  return (
    <SignInForm backgroundColor="#f3f4f6" style={{ position: "relative" }}>
        ...
        <Row className="align-items-center justify-content-center position-static">
          ...
          >
            <SignInForm.Box>
                ...
                <form>
                  ...
                  <div className="form-floating">
                    <input
                      ...
                      name="password"
                    />
                    <label className={cx("floatinginput2")}>
                      Your Password
                    </label>
                  </div>
                  {showpassword ? (
                  ...
                  <div className="form-check d-flex align-items-center mt-6 mb-3">
                    ...
                    >
                      ...
                      <SignInForm.FormText
                        ...
                        onClick={() => router.push("/innerpage/forgot")}
                      >
                        Forgot password
                      </SignInForm.FormText>
                    </div>
              ...
              <div
                className={styles.bottomabsolute}
                style={{ display: "flex" }}
              >
                <div>
                  ...
                  <text
                    ...
                    onClick={() => router.push("/innerpage/Demouser")}
              ...
              <div className={styles.need}> Need Help ?</div>
            </SignInForm.Box>
          </Col>
        </Row>
      </Container>
      {show ? (
        <div className={styles.modal}>
          ...
          <div className={styles.contain}>
            <Modal data={data} emailbefore={state.email} />
          </div>
        </div>
      ) : null}
