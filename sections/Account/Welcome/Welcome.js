...
export default function SignIn() {
  ...
  const [name, setName] = useState(data.user.name.first);

  const [restro, setRestro] = useState(data.workPlaces);
                ...
                {restro.map((dat) => (
                  <div className={styles.mapBox}>
                    <div className={styles.image}>
                      <img
                        src={
                          "https://dungarestro.com.np/wp-content/uploads/2019/01/cropped-dunga-logo-2.png"
                        }
                        className={styles.image2}
                      ></img>
                    </div>
                    <div className={styles.mapName}>
                      {dat.restaurantId.name}
                    </div>
                  </div>
                ))}
              </div>
