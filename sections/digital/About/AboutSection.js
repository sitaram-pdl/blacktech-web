            ...
            <About.Box mrXL="50px" mt="0" mt="30px" mtXL="0" pb="40px" pbLG="0">
              <About.ContentTextBlock className="text-center text-xl-end">
                ...
                <About.Title as="h2" pb="35px" mb="40px">
                  ...
                  {/* helping you grow yours */}you need
                </About.Title>
                <About.Text>
                  To create a more user-friendly experience for your product and
                  take your business to the next level of technology digitally
                </About.Text>
